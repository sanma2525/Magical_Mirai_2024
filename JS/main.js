...
function open_instraction() {
    ...
    document.getElementById("overlay_text").innerHTML = "<h1>説明</h1><h3>この度はこのやり込みゲーをしてくださりありがとうございます。<br>このゲームは次のフレーズのメロディを下の三択から選ぶゲームです。<br><br>青色の音程バーは左のピアノ通りで、<br>ピンク色の音程バーはピアノの1オクターブ上を指しています。<br>正解を選ぶと左上の完成度が上がっていきます。<br><br>前半は間違いの選択肢にノイズがかかっていたりはみ出したりしていますが、<br>後半になるにつれそれらが少なくなり難しくなっていきます。<br><br>ヒントとしましては、選択肢の天井に音程バーが有るものは選ばないほうがいいでしょう。<br><br>※所見の方は一度通してこの素晴らしすぎる楽曲を聞くことを強くおすすめします。</h3>";
}
